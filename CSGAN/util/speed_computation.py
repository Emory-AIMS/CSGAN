...
def grid2coord(trajectory, bbox, horizontal_n, vertical_n):
    # change trajectory to a list
    trajectory = trajectory.tolist()
    coordinate_list = []
    lookup_dict = grid2coord_dictionary(bbox, horizontal_n, vertical_n)
...
def speed_computation(trajectory, bbox, horizontal_n, vertical_n):
    # change trajectory to a list of coordinates
    coordinate_list = grid2coord(trajectory, bbox, horizontal_n, vertical_n)
    average_speed = 0.0
    count = 0
